...
??? question "دپلوی کردم ولی ارور 1101 میده کلادفلر!"
    اکانت کلادفلر شما شناسایی شده، با یک ایمیل رسمی مثل Gmail یه اکانت جدید کلادفلر بسازید، در ضمن در اسم پروژه کلمات مرتبط با پروکسی نباشد.
...
??? question "چرا وقتی میخوام ساب sing-box رو وارد کنم ارور میده"
    کانفیگ‌های پنل حمیدرضا فقط از sing-box نسخه 1.12.0 و بالاتر پشتیبانی میکنن.