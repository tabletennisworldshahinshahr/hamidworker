# :material-new-box:{ .md .middle } راه‌اندازی دستی Workers
...
!!! danger "خطر"
    اسمی انتخاب کنید که کلماتی مانند 'proxy', 'vless', 'vpn' و غیره در آن نباشد، چون ممکنه Cloudflare اکانتتون رو شناسایی کنه و خطای `1101` بده.
